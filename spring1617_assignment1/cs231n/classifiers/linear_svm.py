...
def svm_loss_vectorized(W, X, y, reg):
  ...
  # converts to array of 500,1 . This is to use numpy broadcast to compare each the row of each correct class score
  # TO each column of a row in the training class
  correct_class_scores = correct_class_scores.reshape(len(correct_class_scores),-1)

  # compres a row in the correct class score to each column of a row in the scores matrix
  margins = np.maximum(0, scores - correct_class_scores + 1)

  # sets the score of the correct class to 0
